...
ENABLE_SKOTTIE="true"  # 启用 Skottie 以支持字体管理器
INCLUDE_VIEWER="false"
USE_EXPAT="false"
ENABLE_PATHOPS="true"  # 启用 PathOps 以支持高级路径操作
ENABLE_MATRIX="true"  # 启用矩阵助手代码
ENABLE_CANVAS="true"
GN_FONT="skia_enable_fontmgr_custom_directory=false skia_enable_fontmgr_custom_embedded=true skia_enable_fontmgr_custom_empty=false"
...
GN_SHAPER="skia_use_icu=true skia_use_harfbuzz=true"
